   ...
   <body>
      ...
      <main class="main">
         ...
         <section class="home section" id="home">
            <div class="bookfile" style="padding: 40px; align-items:center;" >
            <h1>Hurrayy! Payment Successful</h1>
            <a href="https://drive.google.com/file/d/1oYz76ybebY4incpEvclx_hfTEqDQR7Gt/view?usp=sharing">Here`s is Your Book File</a>
            </div>           
         </section>
      </main>
